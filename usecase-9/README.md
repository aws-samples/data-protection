...
To review how the roles used in this workshop follow the principle of least privilege see [Least Privilege Document](https://github.com/aws-samples/data-protection/blob/master/usecase-9/img/ACMLeastPrivilgeConcepts.pdf)
